        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    // Venue Details
                    { path: 'venue/:metaurl', component: VenueDetailsComponent },
                    //venue list
                    // { path: 'venue', component: VenueCategoryListComponent },
                    { path: 'banquet-halls', component: VenueCategoryListComponent },
                    //venue list with occasion
                    { path: 'banquet-halls/:occasion', component: VenueCategoryListComponent },
                    //venue list with occasion and city
                    { path: 'banquet-halls/:occasion/:city', component: VenueCategoryListComponent },
                    //venue list with occasion and city and subarea
                    { path: 'banquet-halls/:occasion/:city/:subarea', component: VenueCategoryListComponent },
                    //vendor Details Screen
                    { path: 'vendor-detail/:location/:category/:metaurl', component: VendorDetailsComponent},
                    
                    { path: 'vendor', component: VendorFilterListComponent },
                    { path: 'vendor/:category', component: VendorFilterListComponent },
                    { path: 'vendor/:category/:city', component: VendorFilterListComponent },
                    { path: 'vendor/:category/:city/:subarea', component: VendorFilterListComponent },
                    ...
                    { path: 'compare-vendor', component: VendorCompareComponent },
                ]
            },
